...
> 本文基于 creek/tight 传输库中 FEC 模块的实际实现撰写（`src/channel/fragmenter.cpp`、`src/channel/reassembler.cpp`、`src/channel/report.cpp`、`src/core/bandwidth.cpp`、`src/fec/fec.cpp`），用于专利申请评审与交底，具体法律措辞以代理机构正式稿为准。
